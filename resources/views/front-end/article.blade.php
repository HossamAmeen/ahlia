    ...
    <div class="container">
      <div class="row contactUs-row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <div class="">
            <a href="tel:+{{$configration->phone}}"><button type="button" class="btn intro-btn-order" style="background-color: #2961d0;color: black">اطلب الآن</button></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item-col">
          <div class="card" style="padding: 30px;">
            ...
            <div class="card-body" style="padding: 1rem 0px;">
              ...
              <br><br>
              <h5>
              شركة مكافحة حشرات في الفروانية
               </h5>
              <h5>
              شركة مكافحة حشرات في العاصمة
              </h5>
              <h5>
              شركة مكافحة حشرات في حولي 
              </h5>
              <h5>
              شركة مكافحة حشرات في الجهراء 
              </h5>
              <h5>
              شركة مكافحة حشرات في مبارك الكبير 
              </h5>
              <h5>
              شركة مكافحة حشرات في الأحمدي 
              </h5>
              <h5>
              كلمنا على 0096555615858
              </h5>
              <h5>
                كلمنا على 99050129
                </h5>
