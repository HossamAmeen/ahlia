...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-dark-custum ">
    <a class="navbar-brand " href="{{url('/')}}">
      <img class="navbar-brand-img" src="{{asset('front-site/assets/imgs/logo.png')}}" alt="الاهليه لمكافحة الحشرات">
      ...
      <div class="row contactUs-row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
          <div class="contactUs-txt">
            ...
            font-weight: bold;">الاهليه لمكافحة الحشرات</h1>
            <span>
  ...
  <section id="contactUs" class="contactUs">
    <div class="container">
      <div class="row contactUs-row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
          <div class="contactUs-txt">
            <h4>اتصل ب الاهليه لمكافحة الحشرات</h4>
            <span>
